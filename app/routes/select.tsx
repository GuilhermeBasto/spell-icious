    ...
    <div className="min-h-screen">
      ...
      <div className="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-3">
            <button
              onClick={() => navigate("/")}
              className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white flex items-center gap-2 font-medium transition-colors"
            >
              ← Back
            </button>
          </div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 outline-none"
            />
            {searchQuery && (
              <button
      ...
      <div className="container mx-auto px-4 pt-[200px] pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:items-start">
          ...
          {/* Selection Panel */}
          <div className="lg:col-span-1 lg:sticky lg:top-[200px] lg:h-fit">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-2xl border border-gray-100 dark:border-gray-700  ">
              ...
              <div className="mb-6 relative">
                ...
                {showEmojiPicker && (
                  <div className="absolute z-50 bg-white dark:bg-gray-800 border-2 border-orange-500 rounded-xl shadow-xl p-4 mb-2 max-h-64 overflow-y-auto left-0 right-0">
                    {/* Team photos */}
                    <div className="mb-3">
