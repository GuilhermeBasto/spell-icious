    ...
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-5xl font-black text-transparent bg-clip-text bg-linear-to-r from-orange-400 to-red-600 mb-4">
            🏁 Quick Race
          </h1>
          ...
          <div className="mt-8">
            ...
            {restaurants.length === 0 ? (
              <div className="text-center py-12 text-gray-400">
                ...
                <p className="text-sm">Add at least 2 to start racing 🏎️</p>
              </div>
            ) : (
            ...
            {restaurants.length >= 2 && (
              <button
                ...
                className="w-full py-4 bg-linear-to-r from-orange-500 to-red-600 text-white rounded-xl hover:from-orange-600 hover:to-red-700 transition-all font-bold text-xl shadow-lg hover:shadow-orange-500/50 transform hover:scale-105"
              >
                🏁 Start Race!
              </button>
            )}
            ...
            {restaurants.length === 1 && (
              <div className="text-center text-yellow-400 bg-yellow-500/10 rounded-lg p-4">
